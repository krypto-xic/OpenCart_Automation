...
public class TC_Reg_004 {
	...
	public void register() {
		...
		String actual_text = driver.findElement(By.xpath("//div[starts-with(text(), 'Password')]")).getText();
		String expected_text = "Password confirmation does not match password!";
